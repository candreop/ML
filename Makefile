...
s00   : NAME = ${MODULE}_${ACYEAR}-Slides-${VERSION}\ \(Introduction\)
...
seach : s00 s01 s02 s03 s04 s05 s06 s07 s08 s09 s10 s11 s12

tex_start:
	echo '\documentclass{beamer}'   >  main_tmp.tex
	echo '\input{settings.tex}'     >> main_tmp.tex
...
add_tex00: FORCE
	echo '\input{introduction.tex}' >> main_tmp.tex
add_tex01: FORCE
	echo '\input{lecture_01.tex}'   >> main_tmp.tex
add_tex02: FORCE
	echo '\input{lecture_02.tex}'   >> main_tmp.tex
add_tex03: FORCE
	echo '\input{lecture_03.tex}'   >> main_tmp.tex
add_tex04: FORCE
	echo '\input{lecture_04.tex}'   >> main_tmp.tex
add_tex05: FORCE
	echo '\input{lecture_05.tex}'   >> main_tmp.tex
add_tex06: FORCE
	echo '\input{lecture_06.tex}'   >> main_tmp.tex
add_tex07: FORCE
	echo '\input{lecture_07.tex}'   >> main_tmp.tex
add_tex08: FORCE
	echo '\input{lecture_08.tex}'   >> main_tmp.tex
add_tex09: FORCE
	echo '\input{lecture_09.tex}'   >> main_tmp.tex
add_tex10: FORCE
	echo '\input{lecture_10.tex}'   >> main_tmp.tex
add_tex11: FORCE
	echo '\input{lecture_11.tex}'   >> main_tmp.tex
add_tex12: FORCE
	echo '\input{lecture_12.tex}'   >> main_tmp.tex
