...
\input{parts/shallow_nets/introduction.tex}

% Binary classification problem
\section{Supervised learning for binary classification}
\input{parts/shallow_nets/binary_classification_supervised.tex}

% Perceptron
\section{Single-layer networks for binary classification: The perceptron}
\subsection{Perceptron architecture}
\input{parts/shallow_nets/perceptron_introduction.tex}
\subsection{Biological inspiration: McCulloch-Pitts neuron}
\input{parts/shallow_nets/perceptron_mcculloch_pitts.tex}
\subsection{Mark 1 perceptron}
\input{parts/shallow_nets/perceptron_mark1.tex}
\subsection{The perceptron as a computational unit}
\input{parts/shallow_nets/perceptron_as_computational_unit.tex}

% Perceptron learning
\section{Perceptron training}
\input{parts/shallow_nets/perceptron_training.tex}
...
\input{parts/shallow_nets/closed_form_solution_linear_regression.tex}

% Suggested reading for this part
\subsection{Suggested reading}
\input{parts/shallow_nets/reading.tex}
