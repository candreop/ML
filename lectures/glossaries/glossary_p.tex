...
\newglossaryentry{probabilistic classification}{
  name={probabilistic classification},
  description={
    A type of \gls{classification} task whereby, for a given input, 
    a \gls{ml} model provides a probability distribution 
    over a set of categories, rather than just 
    outputting the most likely category for the input
  }
}
